<%@ Page Title="InstructorEdit" Language="C#" MasterPageFile="~/Main.Master" CodeBehind="Edit.aspx.cs" Inherits="Assignment2_EnterpriseComputing.Programs.Instructors.Edit" %>
            ...
            <EditItemTemplate>
                <fieldset class="form-horizontal">
					...
					<asp:ValidationSummary runat="server" CssClass="alert alert-danger"  />                 
						    ...
						    <asp:DynamicControl Mode="Edit" DataField="Service_Status" runat="server" />

<%@ Page Title="EnrollmentEdit" Language="C#" MasterPageFile="~/Main.Master" CodeBehind="Edit.aspx.cs" Inherits="Assignment2_EnterpriseComputing.Programs.Enrollments.Edit" %>
                ...
                <fieldset class="form-horizontal">
					...
					<asp:ValidationSummary runat="server" CssClass="alert alert-danger"  />                 
							...
							<asp:DynamicControl Mode="Edit" 
								...
								UIHint="ForeignKey" runat="server" />
						    <asp:DynamicControl Mode="Edit" DataField="Student_Types" runat="server" />
						    <asp:DynamicControl Mode="Edit" DataField="Student_Status" runat="server" />

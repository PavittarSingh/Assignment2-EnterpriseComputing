<%@ Page Title="StudentEdit" Language="C#" MasterPageFile="~/Main.Master" CodeBehind="Edit.aspx.cs" Inherits="Assignment2_EnterpriseComputing.Students.Edit" %>
            ...
            <EditItemTemplate>
                <fieldset class="form-horizontal">
					...
					<asp:ValidationSummary runat="server" CssClass="alert alert-danger"  />                 
						    ...
						    <asp:DynamicControl Mode="Edit" DataField="FirstMidName" runat="server" />
